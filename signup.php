...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($password) || empty($username)) {
        ...
        $url = 'https://w3k8rq6ygj.execute-api.us-east-1.amazonaws.com/prod/AddUser';
    ...
    <?php } ?>		
			...
			<form class="form col-lg-6 col-sm-12 col-md-6 col-xs-12 col-md-offset-3" data-toggle="validator" method="POST">
				<div class="form-group">
					<label for="nameField">Username You Want*</label>
					<input type="text" class="form-control" id="unf" name="username" placeholder="Username" required="true" autofocus />
				</div>
				<div class="form-group">
					<label for="emailField">Password You Want*</label>
